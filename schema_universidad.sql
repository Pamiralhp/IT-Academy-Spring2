...
FROM profesor LEFT JOIN departamento ON profesor.id_departamento = departamento.id JOIN persona ON profesor.id_profesor = persona.id
ORDER BY "Nombre departamento", persona.apellido1, persona.apellido2, persona.nombre ASC;
SELECT persona.nombre AS profesor FROM profesor
LEFT JOIN departamento ON profesor.id_departamento = departamento.id
INNER JOIN persona ON profesor.id_profesor = persona.id WHERE departamento.nombre IS NULL;
